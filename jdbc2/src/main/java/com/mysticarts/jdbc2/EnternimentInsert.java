...
public class EnternimentInsert {

        public static void main(String[] args)  {

            EnternimentDaoImpl  enternimentDao = new EnternimentDaoImpl();
            enternimentDao.updateMovieNameById("Kings_Man",40);
            try {
                //load and register
            ...
            try {
                Connection connection =  DriverManager.getConnection("jdbc:mysql://localhost:3306/enterniment" ,"root","Xworkzodc@123Indru");
