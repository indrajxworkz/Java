class Ecomm{
 public static void main(String [] ecomm){
 
	System.out.println("Amazon");
	System.out.println("ebay");
	System.out.println("Walmart");
	System.out.println("Meesho");
	System.out.println("Filpcart");
